...
default_provider: null      # google|openai|azure|openrouter|dashscope|minimax|replicate|atlas|null (null = auto-detect)
...
| `default_model.atlas` | string\|null | null | Atlas Cloud default model |
